...
// fetchData()
  ...
  return (
    <div className=''>
      <div className="bg-pink-500  sticky-bottom  text-white fixed w-full p-4"><Link className='bg-black' to="/cart">I have {myData.length} number of bags here </Link> </div>
...
<div className="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">                      
    ...
    <button onClick={()=>handleAddCart(products)} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Add to Cart
